...
// import Worker from './cnn.worker'
// const myWorker = new Worker()
// if (process.env.NODE_ENV === 'development') {
//   myWorker.postMessage({ type: 'init', options: { wasmPaths: 'http://localhost:9080/static/' } });
// } else {
//   myWorker.postMessage({ type: 'init', options: { wasmPaths: 'resources/app/dist/electron/static/' } });
// } 
