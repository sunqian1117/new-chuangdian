...
exports.cssLoaders = function (options) {
    ...
    return {
        ...
        sass: generateLoaders('sass', { indentedSyntax: true, api: 'modern-compiler', silenceDeprecations: ['legacy-js-api', 'import'] }),
        scss: generateLoaders('sass', { api: 'modern-compiler', silenceDeprecations: ['legacy-js-api', 'import'] }),
